...
export default MMoviesList;

// let idmoviesadd = 70;
// export function onsubmit(event, values) {
//   event.preventDefault();
//   MoviesList.push({ id: idmoviesadd, ...values, love: "bi bi-heart" });
//   console.log(MoviesList);

//   idmoviesadd = idmoviesadd + 1;
// }

// export function deleteSurce(movieId) {
//   MoviesList = MoviesList.filter((val) => val.id !== movieId);
// }
